...
interface Provider {
  ...
  specialty: string;
  location: string;
  rating?: number; // Optional for trusted advisor
...
export default function ProviderDirectoryPage() {
  ...
  const handleSendMessageClick = (doctorName: string) => {
    toast({
      title: "Message Feature (Simulation)",
      description: `In a full version, you could send a message to ${doctorName} here. This feature is currently simulated.`,
      duration: 5000,
    });
  };
