...
import { Star, MapPin, Filter, PlusCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Find medical professionals who treat Morgellons with care and credibility. Reviews are based on Morgellons-specific experiences.</CardDescription>
        </CardHeader>
        ...
        {mockProviders.map(provider => (
          <Card key={provider.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <p><strong>Morgellons Experience:</strong> <Badge variant={provider.morgellonsExperience.includes("Positive") || provider.morgellonsExperience.includes("Knowledgeable") ? "default" : "secondary"}>{provider.morgellonsExperience}</Badge></p>
            </CardContent>
            <CardFooter>
