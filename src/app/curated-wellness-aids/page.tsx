...
export default function CuratedWellnessAidsPage() {
  ...
  const orderedCategories = Object.keys(groupedAids).sort();
    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            A selection of products based on community input and general wellness principles. 
      ...
      <Card className="mt-8">
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
            ...
            <p>Information provided is based on community input or general wellness knowledge. Always consult with a qualified healthcare professional before making any decisions about your health or treatment plan, especially when considering new supplements or products.</p>
